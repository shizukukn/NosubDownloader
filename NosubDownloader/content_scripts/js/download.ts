...
import bugReport = require('./bugreport');
import mukiopress = require('./mukiopress');
import sina = require('./sina');
import xiami = require('./xiami');
...
function sendAddVideoUrlsMessage(urls: string[]): void {
    ...
    var message: nosub.AddVideoUrlsMessage = {
        type: nosub.ADD_VIDEO_URLS_MESSAGE_TYPE,
        urls: urls,
        fileName: title
    };
